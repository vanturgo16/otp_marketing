<li class="{{ request()->is('marketing/*') ? 'mm-active' : '' }}">
    ...
    <ul class="sub-menu" aria-expanded="false">
        <li><a href="{{ route('marketing.inputPOCust.index') }}" class="{{ request()->is('marketing/inputPOCust/*') ? 'active' : '' }}"><i data-feather="edit"></i>Input PO Customer</a></li>
        ...
        {{-- <li><a href="" class="{{ request()->is('marketing/salesOrder/*') ? 'active' : '' }}"><i data-feather="file-text"></i>Sales Order</a></li> --}}
