                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <a href="{{ route('marketing.inputPOCust.create') }}"
                            ...
                            <table id="" class="table table-bordered dt-responsive w-100 datatable-buttons"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="align-middle text-center">PO<br>Number</th>
                                ...
                                <tbody>
                                    <?php $no = 0; ?>
                                    @foreach ($input_po_customer as $data)
                                        <?php $no++; ?>
                                        <tr>
                                            ...
                                            <td class="align-middle text-center">
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <ul class="dropdown-menu"
                                                        ...
                                                        <li>
                                                            <a class="dropdown-item drpdwn-{{ $data->status == 'Request' ? 'scs' : 'wrn' }}"
                                                                href="#" data-bs-toggle="modal"
                                                                data-bs-target="#info{{ $data->id }}"><span
                                                                    class="mdi mdi-arrow-left-top-bold"></span> |
                                                                {{ $data->status == 'Request' ? 'Posted' : 'Un Posted' }}</a>
                                                        </li>
                                                        <li>
