            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">View Order Confirmation</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Marketing</a></li>
                                <li class="breadcrumb-item active">View Order Confirmation</li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <form action="{{ route('marketing.orderConfirmation.update') }}" method="POST">
                            ...
                            <div class="card-header">
                                <i class="mdi mdi-file-multiple-outline label-icon"></i> View Order Confirmation
                            </div>

                            <div class="card-body">
                                <div class="mt-4 mt-lg-0">
                                    <dl class="row">
                                        <dt class="col-sm-3 mb-2"><label>OC Number</label></dt>
                                        <dd class="col-sm-9 mb-2" id="oc_number">{{ $orderConfirmation->oc_number }}</dd>

                                        <dt class="col-sm-3 mb-2"><label>Date</label></dt>
                                        <dd class="col-sm-9 mb-2">
                                            {{ \Carbon\Carbon::parse($orderConfirmation->date)->isoFormat('dddd, D MMMM YYYY', 'ID') }}
                                        </dd>

                                        <dt class="col-sm-3 mb-2"><label>Customer</label></dt>
                                        <dd class="col-sm-9 mb-2">{{ $orderConfirmation->masterCustomer->customer_code }} -
                                            {{ $orderConfirmation->masterCustomer->name }}</dd>

                                        <dt class="col-sm-3 mb-2"><label>Salesman</label></dt>
                                        <dd class="col-sm-9 mb-2">{{ $orderConfirmation->masterSalesman->name }}</dd>

                                        <dt class="col-sm-3 mb-2"><label>Term Payment</label></dt>
                                        <dd class="col-sm-9 mb-2">{{ $orderConfirmation->masterTermPayment->term_payment }}
                                        </dd>

                                        <dt class="col-sm-3 mb-2"><label>Currency</label></dt>
                                        <dd class="col-sm-9 mb-2">{{ $orderConfirmation->masterCurrencies->currency }}</dd>

                                        <dt class="col-sm-3 mb-2"><label>Ppn</label></dt>
                                        <dd class="col-sm-9 mb-2">{{ $orderConfirmation->ppn }}</dd>

                                        <dt class="col-sm-3 mb-2"><label>Remark</label></dt>
                                        <dd class="col-sm-9 mb-2">{{ $orderConfirmation->remark }}</dd>

                                        <dt class="col-sm-3 mb-2"><label>Status</label></dt>
                                        <dd class="col-sm-9 mb-2">{{ $orderConfirmation->status }}</dd>
                                    </dl>
                                </div>
